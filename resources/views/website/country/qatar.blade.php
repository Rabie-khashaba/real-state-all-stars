        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 mb-4 mb-md-0 text-center">
                    <img style="width: 400px; height: 228px" src="{{asset('public/images/country/qatar.png')}}"
                         alt="Example Image"
                ...
                <!-- العمود الثاني: النص -->
                <div class="col-md-7">
                    <h2 style="font-family: 'NowB', sans-serif; font-size: 34px;" class="fw-bold mb-3">{{__('country.qatar')}}</h2>
                    <p  class="country-text" style="font-family: 'NowR', sans-serif;font-size: 15px; line-height: 25px">
                        {!! __('country.qat_real_estate_intro') !!}
                    </p>
        ...
        <div class="row align-items-start w-100">
            ...
            <div class="col-md-6 col-12 order-2 order-md-1 d-flex flex-column justify-content-center">
                ...
                <h2 class="mb-4 section-title">
                    {!! __('country.qat_growth_marketing') !!}
                </h2>
                <!-- عنصر 1 -->
                <div class="border-bottom py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="mb-0 section-subtitle">
                            {!! __('country.qat_market_overview') !!}
                        </p>
                    ...
                    <div class="collapse mt-2" id="collapseOne">
                        ...
                        {!! __('country.qat_market_intro') !!}
                    </p>
                    
                    <p class="mb-0 section-text">
                        {!! __('country.qat_market_phase1') !!}
                    </p>
                    
                    <p class="mb-0 section-text">
                        {!! __('country.qat_market_phase2') !!}
                    </p>
                    
                    <p class="mb-0 section-text">
                        {!! __('country.qat_market_phase3') !!}
                    </p>
                ...
                <div class="border-bottom py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="mb-0 section-subtitle" >
                           {{__('country.role_of_real_estate_marketing_title')}}
                        </p>
                        <button style="color: #000" class="btn btn-link p-0 fs-4 text-decoration-none"
                                type="button"
                                data-bs-toggle="collapse"
                    ...
                    <p class="mb-0 section-text" >
                    {!! __('country.role_of_real_estate_marketing') !!}
                            </p>
                    </div>
                </div>
                ...
                <div class="border-bottom py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="mb-0 section-subtitle" >
                            {!! __('country.leading_real_estate_brands') !!}
                        </p>
                        <button style="color: #000" class="btn btn-link p-0 fs-4 text-decoration-none"
                                type="button"
                                data-bs-toggle="collapse"
                    ...
                    <div class="collapse mt-2" id="collapseThree">
                        <p class="mb-0 section-text" >
                          {!! __('country.leading_real_estate_brands_details') !!}
                        </p>
                ...
                <div class="border-bottom py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="mb-0 section-subtitle">
                            {!! __('country.innovations_in_real_estate_marketing_technology') !!}
                        </p>
                        <button style="color: #000" class="btn btn-link p-0 fs-4 text-decoration-none"
                                type="button"
                                data-bs-toggle="collapse"
                    ...
                    <div class="collapse mt-2" id="collapseFour">
                        <p class="mb-0 section-text">
                          {!! __('country.innovations_in_real_estate_marketing_technology_details') !!}
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-12 order-1 order-md-2 mb-4 mb-md-0 d-flex justify-content-center justify-content-md-center">
                <div class="image-wrapper">
                    <img src="{{ asset('public/images/country/qatarTowe.png') }}"
                         alt="Example Image"
                         class="img-fluid rounded shadow">
                </div>
            </div>
...
<section class="py-5 bg-white">
    <div class="container">
        ...
        <h2 class="mb-4 section3-title text-center text-md-center">
                {{__('country.government_entities_regulating_real_estate_marketing_in_qatar')}}
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-2">
               {!! __('country.government_entities_regulating_real_estate_marketing_in_qatar_details') !!}
            </div>
            ...
            <div class="col-md-12">
                <div class="row text-center g-4 justify-content-center">
                    <div class="col-6 col-md-3">
                        <img src="{{asset('public/images/country/logo_qatar/1.png')}}" alt="Image 2" class="img-fluid logo-img">
                    </div>
                    <div class="col-6 col-md-3">
                        <img src="{{asset('public/images/country/logo_qatar/2.png')}}" alt="Image 3" class="img-fluid logo-img">
                    </div>
                    <div class="col-6 col-md-3">
                        <img src="{{asset('public/images/country/logo_qatar/3.png')}}" alt="Image 4" class="img-fluid logo-img">
                    </div>
                    <div class="col-6 col-md-3">
                        <img src="{{asset('public/images/country/logo_qatar/4.png')}}" alt="Image 4" class="img-fluid logo-img">
                    </div>
                </div>
            </div>
