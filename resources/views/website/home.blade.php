...
@section('title', 'Home')
@section('meta_description', 'Real Estate All Stars — منصة عقارية رائدة تجمع المطورين والمستثمرين في مصر والسعودية والإمارات وعُمان وقطر. اكتشف أفضل المشاريع العقارية وشارك في المسابقة الكبرى.')
@section('meta_keywords', 'عقارات, مسابقة عقارات, real estate competition, Egypt, KSA, UAE, Oman, Qatar, Real Estate All Stars, مشاريع عقارية, استثمار عقاري, مطورين عقاريين')
...
@section('styles')
    <style>
        ...
        .home-judges-carousel {
            display: block !important;
        }

        .home-judges-carousel.owl-hidden {
            opacity: 1 !important;
        }

        .home-judges-carousel:not(.owl-loaded) {
            display: flex !important;
            gap: 10px;
            overflow: hidden;
        }

        .home-judges-carousel .owl-stage {
            display: flex;
            align-items: center;
        }

        .home-judges-carousel .item {
            display: flex;
            justify-content: center;
            flex: 0 0 240px;
        }

        .home-judges-carousel .item img {
        ...
        .prizes-section {
            background-image: url("{{asset('images/home/deadline-bg.png')}}");
            background-size: cover;
            background-position: center;
            height: 298px;
            padding-top: 60px;
...
<section class="hero">
    ...
    Your browser does not support the video tag.
        ...
        <div class="position-absolute bottom-0 w-100 d-flex justify-content-between px-4 pb-4 logos-wrapper">
            <img src="{{ asset('images/logo/Group 1597883384.png') }}" alt="Left Logo" class="hero-logo">
            <!--<img src="{{ asset('images/logo/logo_right.png') }}" alt="Right Logo" class="hero-logo">-->
        </div>
    </section>
...
<section class="container-fluid  p-0 overflow-hidden">
        <div class="row mb-5 g-3"> <!-- g-3 لعمل gap بين الأعمدة -->
            ...
            <div class="col-12 col-md-6  ">
                <div class="section-bg d-flex flex-column justify-content-center align-items-center text-center pt-5 mt-2" style="background-image: url('{{ asset('images/home/hero.png') }}');">
            ...
            <!-- Section 2 -->
            <div class="col-12 col-md-6  ">
                <div class="section-bg d-flex flex-column justify-content-center align-items-center text-center pt-5 mt-2" style="background-image: url('{{asset('images/home/vote-bg.png')}}'); height:579px;">
...
<section class="container-fluid p-4">
    ...
    <div class="owl-carousel home-judges-carousel">
        <div class="item"><img src="{{asset('images/home/person.png')}}" class="img-fluid" alt="Team 2"></div>
        <div class="item"><img src="{{asset('images/home/person.png')}}" class="img-fluid" alt="Team 3"></div>
        <div class="item"><img src="{{asset('images/home/person.png')}}" class="img-fluid" alt="Team 4"></div>
        <div class="item"><img src="{{asset('images/home/person.png')}}" class="img-fluid" alt="Team 5"></div>
        <div class="item"><img src="{{asset('images/home/person.png')}}" class="img-fluid" alt="Team 6"></div>
        <div class="item"><img src="{{asset('images/home/person.png')}}" class="img-fluid" alt="Team 7"></div>
        <div class="item"><img src="{{asset('images/home/person.png')}}" class="img-fluid" alt="Team 8"></div>
        <div class="item"><img src="{{asset('images/home/person.png')}}" class="img-fluid" alt="Team 9"></div>
        <div class="item"><img src="{{asset('images/home/person.png')}}" class="img-fluid" alt="Team 10"></div>
    </div>
</section>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-2 col-md-2">
                    <div class="d-flex flex-column align-items-center">
                        <img src="{{asset('images/home/icon1.png')}}" class="img-fluid mb-2" alt="Prize 1">
                ...
                <div class="col-2 col-md-2">
                    <div class="d-flex flex-column align-items-center">
                        <img src="{{asset('images/home/icon2.png')}}" class="img-fluid mb-2" style="max-height:80px;" alt="Prize 2">
                ...
                <div class="col-2 col-md-2">
                    <div class="d-flex flex-column align-items-center">
                        <img src="{{asset('images/home/icon3.png')}}" class="img-fluid mb-2" style="max-height:80px;" alt="Prize 3">
                ...
                <div class="col-2 col-md-2">
                    <div class="d-flex flex-column align-items-center">
                        <img src="{{asset('images/home/icon4.png')}}" class="img-fluid mb-2" style="max-height:80px;" alt="Prize 4">
                ...
                <div class="col-2 col-md-2">
                    <div class="d-flex flex-column align-items-center">
                        <img src="{{asset('images/home/icon5.png')}}" class="img-fluid mb-2" style="max-height:80px;" alt="Prize 5">
    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center align-items-center">
            ...
            <div class="col-6 col-md-3">
                <div class="d-flex flex-column align-items-center">
                    <img src="{{asset('images/home/icon6.png')}}" class="img-fluid mb-2" alt="Body 1">
                    <div class="d-flex flex-column align-items-center">
            ...
            <div class="col-6 col-md-3">
                <div class="d-flex flex-column align-items-center">
                    <img src="{{asset('images/home/icon8.png')}}" class="img-fluid mb-2" alt="Body 2">
                    <div class="d-flex flex-column align-items-center">
            ...
            <div class="col-6 col-md-3">
                <div class="d-flex flex-column align-items-center">
                    <img src="{{asset('images/home/icon9.png')}}" class="img-fluid mb-2" alt="Body 3">
                    <div class="d-flex flex-column align-items-center">
            ...
            <div class="col-6 col-md-3">
                <div class="d-flex flex-column align-items-center">
                    <img src="{{asset('images/home/icon7.png')}}" class="img-fluid mb-2" alt="Body 4">
                    <div class="d-flex flex-column align-items-center">
...
// Simple countdown to 1 Jan 2026
    ...
    function initOwlCarousel() {
        try {
            const carouselElement = document.querySelector(".home-judges-carousel");
            if (!carouselElement || !window.jQuery || !jQuery.fn.owlCarousel) return;
            ...
            console.warn('Home judges carousel fallback is active.', error);
        }
    }

    document.addEventListener('DOMContentLoaded', initOwlCarousel);
    window.addEventListener('load', initOwlCarousel);
