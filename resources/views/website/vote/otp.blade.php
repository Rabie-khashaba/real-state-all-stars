...
<body>
  <div class="otp-box">
    <div class="overlay">
      ...
      <p class="subtitle">We’ve sent a code to <span class="num">{{ $phone }}</span></p>
      ...
      <form method="POST" action="{{ route('voter.otp.verify') }}" id="otpForm">
        @csrf
      ...
      <div class="resend-text">
        ...
        <form method="POST" action="{{ route('voter.otp.resend') }}" class="d-inline" id="resendForm">
          @csrf
